...
var time_to = "2016-01-01 00:00:00";
var finaltime = "2016-01-01 00:00:00";
var datasetname = "NewYork_TS";
var rgb = 1;
var attrimode = "1";
...
function timeQuery(){
    ...
    if(datasetname == "Brightkite"){lat = 50.971,lon = 10.290,level = 5,time_from = "2008-03-29 00:00:00",time_to = "2010-10-31 00:00:00"};
    if(datasetname == "Gowalla"){lat = 38.981,lon = -97.414,level = 5,time_from = "2009-02-01 00:00:00",time_to = "2010-10-01 00:00:00"};
    if(datasetname == "NewYork_TS"){lat = 40.740,lon = -73.962,level = 12,time_from = "2015-01-01 00:00:00",time_to = "2016-01-01 00:00:00"};
    if(datasetname == "enterprise"){lat = 34.314,lon = 108.708,level = 5,time_from = "1980-01-01 00:00:00",time_to = "2010-01-01 00:00:00"};
    finaltime = time_to;
...
var flagTime1 = false;
$(".tablinksattri_chart").click(function(){
    if(flagTime1 == false){
        $("#attri_chart").hide();
        flagTime1 = true;
    } else {
...
window.onload = function(){setInterval("timespendshow()",100)}
function timespendshow(){
    document.getElementById("timespend").innerHTML="timespend：" + " " + timeSpend[timeSpend.length - 1] +"ms";
}